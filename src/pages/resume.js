...
const Projects = () => (
	<div>
		...
		<section className="work-projects">
			<ul>
				<li>
					https://fullcirclehome.com/ 98% of the theme/front end of the site was
					done by me (Shopify is the platform there, I also worked on adding
					custom sections there)
				</li>
				<li>
					https://orioncoolers.com/ Worked on seamless WordPress/BigCommerce
					visual integration, + coupon feature (to add FREE products to cart
					based on coupons)
				</li>
